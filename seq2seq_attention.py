...
train_dir = "/media/robin/sorry/naive_lab/data"               # Model directory save_dir
...
def main_train():
    ...
    train_path = "/media/robin/sorry/naive_lab/data/train1"
    dev_path = "/media/robin/sorry/naive_lab/data/test1"
    ...
    tl.nlp.create_vocabulary(fr_vocab_path, "/media/robin/sorry/naive_lab/data/small_all.data",
    ...
    tl.nlp.data_to_token_ids(train_path + ".en", en_train_ids_path, fr_vocab_path,
                                tokenizer=None, normalize_digits=normalize_digits,
                                UNK_ID=UNK_ID, _DIGIT_RE=_DIGIT_RE)
    ...
    tl.nlp.data_to_token_ids(dev_path + ".fr", fr_dev_ids_path, fr_vocab_path,
                                tokenizer=None, normalize_digits=normalize_digits,
                                UNK_ID=UNK_ID, _DIGIT_RE=_DIGIT_RE)
    tl.nlp.data_to_token_ids(dev_path + ".en", en_dev_ids_path, fr_vocab_path,
                                tokenizer=None, normalize_digits=normalize_digits,
                                UNK_ID=UNK_ID, _DIGIT_RE=_DIGIT_RE)
...
def main_decode():
    ...
    if is_npz:
        ...
        if ckpt and tf.gfile.Exists(ckpt.model_checkpoint_path):
            ...
            model_eval.saver.restore(sess, "model_translate_enfr.ckpt")
        else:
